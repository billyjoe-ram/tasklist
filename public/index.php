							...
							?>
									<div class="row mb-3 d-flex align-items-center tarefa">
										...
										<div class="col-sm-3 mt-2 d-flex justify-content-between">
											...
											if ($tarefa->status == 'pendente') {
											?>
												<i class="fas fa-edit fa-lg text-info" onclick="editar(<?= $tarefa->id ?>)" style="cursor: pointer;">
												</i>
												<i class="fas fa-check-square fa-lg text-success" onclick="marcarConcluída(<?= $tarefa->id ?>)" style="cursor: pointer;">
												</i>
											<?php
											}
											?>
